...
"""
        ...
        messages = [
            {
                "role": "system",
                "content": "You are an expert programmer skilled in code translation.",
            },
        ...
        return await self.execute_with_resilience(
            make_request, priority=kwargs.get("priority", RequestPriority.NORMAL)
        )
    ...
    async def translate_code(
        ...
        try:
            ...
            translated = await asyncio.to_thread(
                self.translator.translate, code, source_lang, target_lang
            )
