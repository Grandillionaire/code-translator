                    ...
                    class FallbackOpenAIClient:
                        def __init__(self):
                            self.chat = type(
                                ...
                                {
                                    "completions": type(
                                        "obj", (object,), {"create": lambda **kwargs: None}
                                    )()
                                },
                            )()
    ...
    async def create_chat_completion(
        ...
        **kwargs,
        ...
        try:
            ...
            return {"content": content, "usage": usage, "model": model, "full_response": response}
...
def check_openai_compatibility() -> Dict[str, Any]:
    ...
    result = {"installed": False, "version": None, "is_new_version": False, "import_error": None}
