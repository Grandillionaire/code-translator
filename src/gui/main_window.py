...
from PyQt6.QtWidgets import (
    ...
    QSplitter, QFrame, QToolBar, QStatusBar,
    QSystemTrayIcon, QMenu
)
from PyQt6.QtCore import Qt, QPoint, QTimer, pyqtSignal, QPropertyAnimation, QEasingCurve, QByteArray
...
class TranslatorWindow(QMainWindow):
    ...
    def load_translation(self, source_lang: str, target_lang: str, source_code: str, translated_code: str):
        ...
        self.translation_widget.load_translation(source_lang, target_lang, source_code, translated_code)
